...
class DienstleistungenPageTests(unittest.TestCase):
    ...
    def test_first_product_page_all_tests_of_that_page(self):
        ...
        try:
            ...
            self.assertEqual(self.dens_page.first_product_img_tag_check_src_atribute(), datas.first_src_img)
            self.assertEqual(self.dens_page.first_product_box_1_picture_check_src_atribute(), datas.first_box_1_src)
            self.assertEqual(self.dens_page.first_product_box_2_picture_check_src_atribute(), datas.first_box_2_src)
            self.assertEqual(self.dens_page.first_product_box_3_picture_check_src_atribute(), datas.first_box_3_src)
            self.assertTrue(self.dens_page.first_product_img_tag_is_displayed)
            self.assertTrue(self.dens_page.first_product_box_1_picture_is_displayed)
            self.assertTrue(self.dens_page.first_product_box_2_picture_is_displayed)
            self.assertTrue(self.dens_page.first_product_box_3_picture_is_displayed)
            self.dens_page.first_product_next_button()
            self.assertEqual(self.dens_page.first_product_img_tag_check_src_atribute(), datas.first_box_1_src)
            self.assertEqual(self.dens_page.first_product_box_1_picture_check_src_atribute(), datas.first_box_2_src)
            self.assertEqual(self.dens_page.first_product_box_2_picture_check_src_atribute(), datas.first_box_3_src)
            self.assertEqual(self.dens_page.first_product_box_3_picture_check_src_atribute(), datas.first_src_img)
            self.assertTrue(self.dens_page.first_product_img_tag_is_displayed)
            self.assertTrue(self.dens_page.first_product_box_1_picture_is_displayed)
            self.assertTrue(self.dens_page.first_product_box_2_picture_is_displayed)
            self.assertTrue(self.dens_page.first_product_box_3_picture_is_displayed)
            self.dens_page.first_product_next_button()
            self.assertEqual(self.dens_page.first_product_img_tag_check_src_atribute(), datas.first_box_2_src)
            self.assertEqual(self.dens_page.first_product_box_1_picture_check_src_atribute(), datas.first_box_3_src)
            self.assertEqual(self.dens_page.first_product_box_2_picture_check_src_atribute(), datas.first_src_img)
            self.assertEqual(self.dens_page.first_product_box_3_picture_check_src_atribute(), datas.first_box_1_src)
            self.assertTrue(self.dens_page.first_product_img_tag_is_displayed)
            self.assertTrue(self.dens_page.first_product_box_1_picture_is_displayed)
            self.assertTrue(self.dens_page.first_product_box_2_picture_is_displayed)
            self.assertTrue(self.dens_page.first_product_box_3_picture_is_displayed)
            self.dens_page.first_product_next_button()
            self.assertEqual(self.dens_page.first_product_img_tag_check_src_atribute(), datas.first_box_3_src)
            self.assertEqual(self.dens_page.first_product_box_1_picture_check_src_atribute(), datas.first_src_img)
            self.assertEqual(self.dens_page.first_product_box_2_picture_check_src_atribute(), datas.first_box_1_src)
            self.assertEqual(self.dens_page.first_product_box_3_picture_check_src_atribute(), datas.first_box_2_src)
            self.assertTrue(self.dens_page.first_product_img_tag_is_displayed)
            self.assertTrue(self.dens_page.first_product_box_1_picture_is_displayed)
            self.assertTrue(self.dens_page.first_product_box_2_picture_is_displayed)
            self.assertTrue(self.dens_page.first_product_box_3_picture_is_displayed)
